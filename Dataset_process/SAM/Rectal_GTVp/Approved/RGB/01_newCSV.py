...
# 加载原始 CSV，没有列名则添加
df = pd.read_csv(r"D:\SAM\Rectal\CTV\146p\20251126\dataset\train\delete\train_nii.csv", header=None, names=["image", "mask"])
...
df_sorted[["image", "mask", "nii_paths"]].to_csv(r"D:\SAM\Rectal\CTV\146p\20251126\dataset\train\pseudo_train_nii.csv", index=False)
