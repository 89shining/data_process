...
# 加载原始 CSV，没有列名则添加
df = pd.read_csv("D:/SAM/GTVp_CTonly/20250707/dataset/test/test_nii.csv", header=None, names=["image", "mask"])
...
df_sorted[["image", "mask", "nii_paths"]].to_csv("D:/SAM/GTVp_CTonly/20250707/dataset/test/newtest_nii.csv", index=False)
